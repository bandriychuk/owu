...
// let arr = [100,250,50,168,120,345,123];
// let sum = 0;
...
//
//
// let averagePrice = [sum/arr.length];
//
// console.log(averagePrice);

// for (let i = averagePrice.length - 1; i >= 0; i--) {
//     const averagePriceElement = averagePrice[i];
//     console.log(averagePriceElement);
// }
...
//
// let arr = ["String1", "String2", 1, 2, 3, "String3", 5, 7, true, false];
// let arr2 = [];
